        ...
        <div className="bg-[url('./src/assets/images/header/header-banner.png')] py-72 bg-cover bg-center">
            <div className="grid grid-cols-2">
                ...
                <div className="text-white">
                    ...
                    <p className="leading-8">It's coffee time - Sip & Savor - Relaxation in every sip! Get the nostalgia back!! Your companion of every <br /> moment!!! Enjoy the beautiful moments and make them memorable.</p>
